...
dataset = SocNavHomoDataset(evaluation_trajectories, '.', contextQ_file, timestamp_threshold = FRAME_THRESHOLD)
...
with torch.no_grad():
    for val_data in loader:
        ...
        predictions = model(traj_batch, metrics_batch, seq_length).squeeze()
